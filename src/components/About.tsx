...
export default function About() {
    return (
        <>
            {/* Sobre Nós */}
            <section className="py-24 px-6 relative z-10 bg-zinc-900 border-t border-zinc-800 [break-inside:avoid] print:py-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <motion.div
                                ...
                                className="bg-zinc-900/50 border border-zinc-800 p-8 rounded-2xl print:bg-zinc-900 print:border-zinc-700"
                            >
